    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('klub.rekomendasi')}}" >
                        @csrf
                        <center>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="goal" type="text" class="form-control" name="goal" value="{{ old('goal') }}" >
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="assist" type="text" class="form-control @error('assist') is-invalid @enderror" name="assist" value="{{ old('assist') }}" required autocomplete="assist">
                            </div>
                        </div>
                        <div class="form-group row">
...
<h2 class="mt-5">HASIL REKOMENDASI PEMAIN</h2>
