...
@endif
      <div class="left">
        <button type="submit" onclick="window.location.href='{{route('klub.showStrukturAll', $id)}}'" style="display: flex; margin-left: 0px;" class="btn btn-primary mb-2">EDIT STRUKTUR</button>
      </div>
