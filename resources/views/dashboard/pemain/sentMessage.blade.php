...
@endif
        <div class="row">
            ...
            <div class="col-sm-10" style="border: 2px solid black;">
                <table>
                    ...
                    <tr>
                        ...
                        <td><button class="btn btn-primary" onclick="window.location.href='{{route('pemain.showOpenSentMessage', $message['id'])}}'">Open</button></td>
                    </tr>  
                    @endforeach
         ...
         <!-- Modal -->
          <form action="{{route('pemain.sentMessage')}}" method="POST">
            @csrf
